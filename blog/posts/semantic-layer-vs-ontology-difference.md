...
head:
  ...
  - - meta
    - property: og:url
      content: https://datus.ai/blog/semantic-layer-vs-ontology-difference/
  - - meta
    - property: og:image
...
- [Semantic layer vs ontology: why AI agents need both](/blog/semantic-layer-vs-ontology/) — the architecture answer: governed metrics first, ontology and agent context on top
